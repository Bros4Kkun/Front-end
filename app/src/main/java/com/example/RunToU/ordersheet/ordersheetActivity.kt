...
import com.example.RunToU.login.authenticationData.SessionControl.sess
...
import com.example.RunToU.volley.chatroomVolley.chatroomVolley.chatroomVolley
                ...
                try {
                    ...
                    btnChat.setOnClickListener(View.OnClickListener {
                        chatroomVolley(
                            ...
                            if(it){
                                listtochatData.chatindex = listtochatData.chRo
                                val intent = Intent(this, chatroomActivity::class.java)
                                stompClass.stompclass.subscribe("/topic/chatroom/", listtochatData.chRo)
